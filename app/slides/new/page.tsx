...
export default function NewSlideDeckPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-black dark:text-white">Slide Deck Builder</h1>
        <p className="text-sm text-gray-500 mt-1">Create a custom Google Slides presentation.</p>
      </div>

      {result && (
        <div className="mb-6 rounded-md bg-green-50 border border-green-200 p-4">
          <p className="text-sm font-semibold text-green-800 mb-1">Slide deck created!</p>
          <a href={result.url} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-700 underline break-all">
      ...
      <form onSubmit={handleGenerate} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-black dark:text-white mb-1">Subtitle</label>
            <input
              type="text"
              value={subtitle}
          ...
          <div>
            <label className="block text-sm font-semibold text-black dark:text-white mb-1">Slides Template URL (optional)</label>
            <input
              type="url"
              value={templateUrl}
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <div>
              <p className="text-sm font-semibold text-black dark:text-white">Slides</p>
